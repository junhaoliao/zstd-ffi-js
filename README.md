...
A JavaScript/TypeScript library for decompressing Zstandard (zstd) compressed data using WebAssembly.

## Features

- Fast decompression using the native Zstandard C library compiled to WebAssembly.
...
```javascript
import ZstdDecompressor from 'zstd-decompressor';
